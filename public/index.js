...
const games = [
    { name: "Sample Game 1", url: "#" },
    { name: "Sample Game 2", url: "#" },
];
...
themeRadios.forEach(radio => {
    radio.addEventListener("change", () => {
        if (radio.value === "light") document.body.style.background = "#f0f0f0";
        else document.body.style.background = "url('https://images.unsplash.com/photo-1514897575457-c4db467cf78e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0') center/cover no-repeat fixed";
        document.body.style.color = radio.value === "light" ? "#000" : "#fff";
    });
});
